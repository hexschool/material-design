...
![image alt](https://gblobscdn.gitbook.com/assets%2F-MLCYr9ilZP2Zl74Yozc%2F-MLS0RqC3vYT3BQj_myD%2F-MLgA4KwjNfigK5oEvcI%2F5.png?alt=media&token=933a7c98-fd3e-4b2c-bb02-05e474d1b201)
...
![image alt](https://gblobscdn.gitbook.com/assets%2F-MLCYr9ilZP2Zl74Yozc%2F-MLS0RqC3vYT3BQj_myD%2F-MLgDEEEeQMDL7Kf0hoo%2F4.png?alt=media&token=b5f2f870-5213-4c0b-ae2a-40959caf3857)

> Do.高度和寬度可以變化

![image alt](https://gblobscdn.gitbook.com/assets%2F-MLCYr9ilZP2Zl74Yozc%2F-MLS0RqC3vYT3BQj_myD%2F-MLgDWVA7UxG6y95G2Y6%2F5.png?alt=media&token=383ca654-9f18-4aab-a37a-41fe8ddf350f)

> Don't.物件厚度應永遠都是 1 dp
...
在沒有改變高度的狀態下不要使用陰影。
1.上視圖。
2.等軸測投影 3D 圖，僅使用顏色而不是光線和高度來描繪陰影。
...
> Do
Material 可以顯示任何形狀與顏色。內容可以獨立顯現於 Material，但被限制於 Ｍaterial 的範圍內。
...
![image alt](https://lh3.googleusercontent.com/7DJfX5QpX3mFWtygaLYHMNb433wwd6gMec8o1SDScj3LzMG1zo8_BlsWOAqIpxtl1N-XhJyfwM0shBbj5s_-bfGg-OCML2vXV5uq7A=w1064-v0)

> Do
輸入的事件只會影響 Material 的表面。

![image alt](https://lh3.googleusercontent.com/cjB5QIG0CoCVs4S3EGTx6QZIJI4nioa8RuC489P2R6xOkBGCtLQos1Ub10UKge97fdaP0zfaRFVFzHRIVpgeSWWZ2qoxgPl4w5jCsg=w1064-v0)
...
![image alt](https://lh3.googleusercontent.com/QDlr41yytdtgIms9GF69MdfrLgq01ZoRJmj3l_HE5tybnKw5bwSpxwzJlc2hT3BWYvkYOPhVKdzYBDmEQ9wFP2GAtb57LwEzknS2JC4=w1064-v0)

> Do
防止多個元素佔據空間中的同一點，例如通過高度區分元素。

![image alt](https://lh3.googleusercontent.com/SdPajfpni-qttHwXaGTZPhsATGXQcP0g0-Qsykwg9XcjtnOJUPtHd8zVPI3q6-_iBAvIf5A9XwOkq-fT4cYrAfHbmQ47X7yHicNfSyU=w1064-v0)
...
> Do
Material 只能透過不透明度、大小與位置的改變進場與出場。

儘管 Material 的內容可能會具有這些屬性，但他並不是向液體或凝膠一樣的流體。
...
1. Material 可以在整個表面上均勻的改變透明度。
2. Material 可以改變其部分表面的不透明度。
...
* 剛性表面在所有互動中保持相同大小。
* 伸縮表面可以在大小限制內沿著一個或多個邊緣伸縮，並為剛性表面。
* 視窗化表面在操作過程中保持相同的大小。他們可以在限制區域內滾動並顯示其內容。觸碰到限制範圍後，則在其滾動方向以剛性表面呈現。
...
> Material 表面尺寸可以保持剛性，但內容可以在表面上滾動或平移
...
> 單個表面可以包含多個平移區塊，例如獨立於滾動列表（2）平移的嵌入式地圖（1）
...
> 表面可以保持在一個固定位置。上方的 app bar （1）保持固定位置，而卡片列表（2）僅在其後方垂直滾動。
...
> 警告
> 1. 透明或半透明表面上的內容物可能需要進行背景處理以保持清晰度。
> 2. 等軸測圖。
...
![image alt](https://lh3.googleusercontent.com/WqGEB4bHD_n7uE8Pt4ZW9FlR0DDgAr9iym3NLBzkrAwMDLYHGlgLVP69cr9qYG8nFlX23RKkByfgPOcpGGxe1723k67atp4yaDs-mj4=w1064-v0)

> 當背景內容顯示紗幕內容時，前景內容將引起更多關注。

![image alt](https://lh3.googleusercontent.com/REP3S1xGOfskFZ3sw8yXYtTfh3sHVMS_-9DAOtle1srzZZ5a-crcf8oi0deYO_FhcHpe7rSeDpF37VHDCjPg0laiE8wm2fT-gnh47g=w1064-v0)

> 紗幕減輕了正面顯示的內容，並將注意力吸引到其後面的表面。
